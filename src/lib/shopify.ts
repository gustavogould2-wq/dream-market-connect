...
export const SHOPIFY_STORE_PERMANENT_DOMAIN = "shop-go-22c5b-18ffk0qu.myshopify.com";
export const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
export const SHOPIFY_STOREFRONT_TOKEN = "b4ae340d01320facdde0dc550f868de0";
...
export async function storefrontApiRequest(query: string, variables: Record<string, unknown> = {}) {
  ...
  if (response.status === 402) {
    toast.error("Shopify: pagamento necessário", {
      description:
        "O acesso à API Shopify requer um plano ativo. Visite https://admin.shopify.com para fazer upgrade.",
    });
    return null;
  }
